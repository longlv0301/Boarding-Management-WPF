        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomFee = table.Column<decimal>(type: "TEXT", nullable: false),
                    ElectricFee = table.Column<decimal>(type: "TEXT", nullable: false),
                    WaterFee = table.Column<decimal>(type: "TEXT", nullable: false),
                    OtherFees = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Month = table.Column<int>(type: "INTEGER", nullable: false),
                    Year = table.Column<int>(type: "INTEGER", nullable: false),
                    ElectricOld = table.Column<int>(type: "INTEGER", nullable: false),
                    ElectricNew = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositAmout = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "TEXT", nullable: false),
                    IdentifyCard = table.Column<string>(type: "TEXT", nullable: false),
                    PhoneNumber = table.Column<string>(type: "TEXT", nullable: false),
                    LicensePlate = table.Column<string>(type: "TEXT", nullable: false),
                    IsContractOwner = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
